...
filename_analysis = 'calibration-data/%s/kmedoids_clustered_zero_crossing_channel_detections.all.analysis.json' % (run_id)
filename_zc = 'calibration-data/%s/kmedoids_clustered_zero_crossing_channel_detections.all.json' % (run_id)
filename_hist = 'calibration-data/%s/zero_crossing_detections.histogram.all.json' % (run_id)
...
#filename_zc = 'calibration-data/%s/zero_crossing_detections.channels.all.json' % (run_id)
#filename_hist = 'calibration-data/%s/zero_crossing_detections.histogram.all.json' % (run_id)

filename_out_outliers = 'calibration-data/%s/zero_crossing_detections.channels.outliers.json' % (run_id)
filename_out_inliers = 'calibration-data/%s/zero_crossing_detections.channels.inliers.json' % (run_id)
...
file_out_zc = 'calibration-data/%s/zero_crossing_detections.channels.all.html' % (run_id)
