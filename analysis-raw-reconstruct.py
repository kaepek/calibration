...
print(f'angular_displacement_cw [rads]: {(angular_displacement_cw):.2f} +/- {(errors_cw[0]):.5f}')
print(f'phase_current_displacement_cw [rads]: {(phase_current_displacement_cw):.2f} +/- {(errors_cw[1]):.5f}')
...
print("-----------------------")
print(f'angular_displacement_ccw [rads]: {(angular_displacement_ccw):.2f} +/- {(errors_ccw[0]):.5f}')
print(f'phase_current_displacement_ccw [rads]: {(phase_current_displacement_ccw):.2f} +/- {(errors_ccw[1]):.5f}')
...
fout='calibration-data/raw_reconstruction_%s.png' % (combined_identifier)
print(fout)
