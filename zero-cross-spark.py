...
file_in = 'calibration-data/%s/kalman_smoothed_merged_capture_data.json' % (run_id)

file_out_zc = 'calibration-data/%s/zero_crossing_detections.channels.all.json' % (run_id)
file_out_hist = 'calibration-data/%s/zero_crossing_detections.histogram.all.json' % (run_id)
