...
fout='calibration-data/%s_Fourier_pos_voltage_fit2.png' % (combined_zc_map_id)
print(fout)
...
partial_sin_wave_tuple_list = analyse.mean_and_std_to_partial_sin_wave(zc_map["mean"])
print("returned: partial_sin_wave_tuple_list")
print(partial_sin_wave_tuple_list)