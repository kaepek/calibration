...
combination_identifier = utils.random_id()

print("run_ids_str", run_ids_str)
...
with open('calibration-data/direct_reconstruction_%s.id' % combination_identifier, "w") as fout:
    fout.write(run_ids_str)
with open('calibration-data/tmp_last_combination', "w") as fout:
    fout.write(combination_identifier)
...
fout='calibration-data/raw_reconstruction_direct_comp2_%s.png' % (combination_identifier)
print(fout)
