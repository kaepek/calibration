...
filename_in_zc_inliers = 'calibration-data/%s/kmedoids_clustered_zero_crossing_channel_detections.inliers.json' % (run_id)
filename_analysis = 'calibration-data/%s/kmedoids_clustered_zero_crossing_channel_detections.inliers.analysis.json' % (run_id)
filename_hist = 'calibration-data/%s/zero_crossing_detections.histogram.all.json' % (run_id)
file_out_zc = 'calibration-data/%s/zero_crossing_detections.channels.inliers.html' % (run_id)
